...
namespace Fargowiltas.UI
{
    public class StatButton : UIState
    {
        ...
        public override void OnActivate()
        {
            ...
            IconHighlight = new UIHoverTextImageButton(Fargowiltas.UserInterfaceManager.StatsButton_MouseOverTexture, Language.GetTextValue("Mods.Fargowiltas.UI.StateSheet.Name"));
